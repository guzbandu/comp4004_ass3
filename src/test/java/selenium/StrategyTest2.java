...
public class StrategyTest2 {
	...
	public void aiStrategy1play2() {
		...
		//Add an AI player with two pair
		...
		Card card33 = new Card("rank-6", "hearts");
		Card card34 = new Card("rank-9", "spades");
		...
		Card card16 = new Card("rank-q", "diams");
		...
		ai1FinalHand.addCard(card13);
		ai1FinalHand.addCard(card14);
		ai1FinalHand.addCard(card16);

		// Submit a "rigged" exchange for AI2 
		Card card26 = new Card("rank-2", "spades");
		...
		ai2FinalHand.addCard(card24);
		ai2FinalHand.addCard(card26);
		
		// Submit a "rigged" exchange for AI3
		Card card36 = new Card("rank-9", "diams");
		...
		results.put("Agent 2", "ranked 4");
		results.put("Agent 3", "ranked 3");
